...
myDFPlayer.playMp3Folder(27);  //the life you lead can 
delay(4500);
myDFPlayer.pause();
...
myDFPlayer.playMp3Folder(30);  //_____barking dogs
delay(8600); 
myDFPlayer.pause();
delay(500); 
...
if(b==2){
myDFPlayer.playMp3Folder(21);  //do we have to hear..dog dream
delay(5000);
myDFPlayer.pause();
...
if(q==1){
myDFPlayer.playMp3Folder(05);  // did you say something?
delay(7000);
myDFPlayer.pause();

myDFPlayer.playMp3Folder(24);  //Not me but here's a weird dog
delay(3500);
myDFPlayer.pause();

myDFPlayer.playMp3Folder(29);  //Meow
delay(5900);
myDFPlayer.pause();
...
if(q==2){
myDFPlayer.playMp3Folder(31);  //Eat it!
delay(2000);
myDFPlayer.pause();

myDFPlayer.playMp3Folder(45);  //no, you eat it
delay(2000);
myDFPlayer.pause();
...
if (u>2) {u=1;}
if(u==1){
myDFPlayer.playMp3Folder(49);  //pepperbox, black pepperbox
delay(3400);
myDFPlayer.pause();
...
if(u==2){
myDFPlayer.playMp3Folder(5);  // Did you hear something?
delay(6000);
myDFPlayer.pause();
...
if (w>2) {w=1;}
if(w==1) {
myDFPlayer.playMp3Folder(12); // You think that's funny, it's not
delay(3000);
myDFPlayer.pause();
...
if (s>2) {s=1;}
if(s==1) {
myDFPlayer.playMp3Folder(92); // Rough Boy
delay(230000);
myDFPlayer.pause();
}
if(s==2) {
myDFPlayer.playMp3Folder(85); //  ghost riders
delay(195000);
myDFPlayer.pause();
}
...
if (r>2) {r=1;}
if(r==1) {
myDFPlayer.playMp3Folder(1); //vulture
delay(4000);
myDFPlayer.pause();

myDFPlayer.playMp3Folder(16); //woodpecker
delay(7500);
myDFPlayer.pause();
...
if(r==2) {
myDFPlayer.playMp3Folder(33); //You need to hear about the dog dream
delay(3000);
myDFPlayer.pause();
}
...
if (c>2) {c=1;}
if(c==1) {
myDFPlayer.playMp3Folder(27); // The life you lead can be your own
delay(4000);
myDFPlayer.pause();
}

if(c==2) {
myDFPlayer.playMp3Folder(33); //  You need to hear .. dog dream
delay(3000);
myDFPlayer.pause();
}
