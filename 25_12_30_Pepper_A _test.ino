...
#define D10 13   //radio receiver RX2 functions
#define D11 12  
#define D12  9

#define D0  8 //radio receiver RX1 functions
#define D1  7
#define D2  5
...
myDFPlayer.playMp3Folder(21);  //________ do we have to hear about his stupid
delay(4500);
myDFPlayer.pause();

myDFPlayer.playMp3Folder(5);  //___________ did you say something, I thought
delay(6000);
myDFPlayer.pause();
}
...
if(b==1){
myDFPlayer.playMp3Folder(41);  //I'm sorry, you can't stand here
delay(7000);
myDFPlayer.pause();
...
if(b==2){
myDFPlayer.playMp3Folder(01);  //birds
delay(4000);
myDFPlayer.pause();

myDFPlayer.playMp3Folder(15);  //birds
delay(4000);
myDFPlayer.pause();

myDFPlayer.playMp3Folder(20);  //is that those damn birds again?
delay(3000);
myDFPlayer.pause();
...
if(q==1){
myDFPlayer.playMp3Folder(02);  //bird
delay(4000);
myDFPlayer.pause();

myDFPlayer.playMp3Folder(16);  //bird
delay(4000);
myDFPlayer.pause();

myDFPlayer.playMp3Folder(5);  //Did you say something?
delay(6500);
myDFPlayer.pause();
...
if(q==2){
myDFPlayer.playMp3Folder(32);  //that devilhead is a birdbrain,
delay(8000);
myDFPlayer.pause();
...
if (u>2) {u=1;}
if(u==1){
myDFPlayer.playMp3Folder(46);  //here's Black Pepper by New Jorba singers
delay(5000);
myDFPlayer.pause();

myDFPlayer.playMp3Folder(87);  //Black Pepper - New Jorba
delay(180000); 
myDFPlayer.pause();
delay(500); 
...
if(u==2){
myDFPlayer.playMp3Folder(100);  //Pepper
delay(102000);
myDFPlayer.pause();
...
delay(500);
myDFPlayer.playMp3Folder(40);  // You said butthole!
delay(2000);
myDFPlayer.pause();

delay(500); 

myDFPlayer.playMp3Folder(37);  // Butthole, butthole!
delay(1600);
myDFPlayer.pause();
...
myDFPlayer.playMp3Folder(49); //__________pepper box, black pepper box
delay(4000);  
myDFPlayer.pause();
delay(500);

myDFPlayer.playMp3Folder(38); //__made with premium peppercorns
delay(3200);  
myDFPlayer.pause();
delay(1000);
...
if (p>2) {p=1;}
if(p==1) {
myDFPlayer.playMp3Folder(19); //_That's Pepper by Butthole Surfers 
delay(4500);
myDFPlayer.pause();
...
if(p==2) {
myDFPlayer.playMp3Folder(46); //Here's Black Pepper by Yoruba
delay(4500);
myDFPlayer.pause();

myDFPlayer.playMp3Folder(87); //Black Pepper by Yoruba Singers
delay(180000);
myDFPlayer.pause();
...
if(s==2) {
myDFPlayer.playMp3Folder(90); //  What's going on
delay(290000);
myDFPlayer.pause();
}
...
if (r>2) {r=1;}
if(r==1) {
myDFPlayer.playMp3Folder(47); //__Here's Black Pepper by Micropop
delay(4000);
myDFPlayer.pause();
...
if(r==2) {
myDFPlayer.playMp3Folder(85); //__Ghost Riders in the Sky
delay(195000);
myDFPlayer.pause();
}
...
if (c>2) {c=1;}
if(c==1) {
myDFPlayer.playMp3Folder(90); //____What's up
delay(290000);
myDFPlayer.pause();
}

if(c==2) {
myDFPlayer.playMp3Folder(89); //  dog dream story
delay(38000);
myDFPlayer.pause();
}
